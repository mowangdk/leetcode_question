...
_HEADER_X_POWERED_BY = {'X-Powered-By': 'fake_tornado/0.1'}
...
class Response(object):
    ...
    def set_cookie(self, name, value, max_age=None, expires=None, path='/',
        ...
        cookie = ['{}={}'.format(quote(name), quote(value))]
        if expires:
...
class Application(object):
    ...
    def build_url_spec(self):
        return [Controller(url_regex, handler) for url_regex, handler in self.url_handler]
